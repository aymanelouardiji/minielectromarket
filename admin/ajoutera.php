  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" style="font-weight: bold;" aria-current="page" href="affichera.php">Accessoires</a>
        </li>
...
<form method="post">
  <div class="mb-3">
    <h2>Pour ajouter des accessoires</h2>
  ...
  <button type="submit" name="v" class="btn btn-success">Ajouter un nouveau produit</button>
</form>
</div></div></div>
<?php 
   if(isset($_POST['v']))
