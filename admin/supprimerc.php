...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      <li class="nav-item">
        <a class="nav-link" aria-current="page" href="supprimer.php">Supprimer un produit-vetements</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" style="font-weight: bold;" aria-current="page"  href="supprimerc.php">Supprimer un produit-cosmetiques</a>
        </li>
        <li class="nav-item">
...
<form method="post">
  <div class="mb-3">
  <div class="mb-3">
   <h2>Supprimer un produit cosmetique</h2>
    <label for="exampleInputPassword1" class="form-label">Identifiant du produit</label>

    <input type="number" class="form-control" name="idcosmetic" required>
   
  </div>

 
  <button type="submit" name="valide" class="btn btn-danger">Supprimer le produit</button>
</form>
...
<?php
  ...
  {
    if(isset($_POST['idcosmetic']))
    {
    if(!empty($_POST['idcosmetic'])  AND is_numeric($_POST['idcosmetic']))
	    {
	    	
	    	$idcosmetic = htmlspecialchars(strip_tags($_POST['idcosmetic']));
          
          try 
          {
            supprimerc($idcosmetic);
          }
          catch (Exception $e) 
          {
          	$e->getMessage();
