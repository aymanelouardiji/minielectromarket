  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link " href="affichera.php">Accessoires</a>
        </li>
...
<?php foreach($Cosmetics as $cosmetic): ?>
                <tr>
                <th scope="row"><?= $cosmetic->id ?></th>
                <td>
                <img src="<?= $cosmetic->image ?>" style="width: 15%">
                </td>
                <td><?= $cosmetic->nom ?></td>
                <td style="font-weight: bold; color: green;"><?= $cosmetic->prix ?>DH</td>
                <td><?= substr($cosmetic->description, 0, 100); ?>...</td>
                <td><a href="editerc.php?id=<?= $cosmetic->id ?>"><i class="fa fa-pencil" style="font-size: 20px;"></i></a></td>
                </tr>      
<?php endforeach; ?>
