...
<!-- header section ends -->
<!-- home section starts  -->
<a  href ="#Accessoires"class="home" id="home">
    <div class="content">
    </div>
</a>
<!-- home section ends -->
...
<h1 class="heading" id="Accessoires"><span>Accessoires</span> </h1>
<main>
...
<?php foreach($Accessoires as $accessoire): ?> 
  <div class="col box">
    <div class="card shadow-sm">
      ...
      <img src="<?= $accessoire->image ?>" style="  display:center">
      <h3 class="price"><?= $accessoire->nom ?></h3>
      <div class="card-body">
        <p class="card-text"><?= substr($accessoire->description, 0, 160); ?>...</p>
   
          <div class="price"><?= $accessoire->prix ?> DH </div>
          <a href="#" class="btn"><i class="fas fa-shopping-cart"></i> Acheter</a>
...
<section class="footer" id="Contact">
    ...
    <div class="box-container">
        ...
        <div class="boxf">
            ...
            <a href="#Accessoires" class="links"> <i class="fas fa-arrow-right"></i> Accessoires </a>
